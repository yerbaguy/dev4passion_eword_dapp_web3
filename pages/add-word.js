...
function onChange(e) {
    ...
    setEWord(() => ({ ...eword, [e.target.engword]: e.target.plword }))
    console.log("eword-eng", e.target.engword)
    console.log("eword-pl", e.target.plword)
  }
...
//   }
   ...
   console.log("eword-engword", eword.engword)
   console.log("eword-plword", eword.plword)
...
//   }
  ...
  const uploadToIPFS = async (file) => {
    ...
    try {
     ...
     console.log("URL", URL.engword)
     console.log("URL", URL.plword)
     return URL;
   } catch (error) {
